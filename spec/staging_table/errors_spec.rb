...
RSpec.describe "StagingTable Error Handling" do
  ...
  describe StagingTable::ConfigurationError do
    ...
    it "is raised for sqlite upsert without conflict_target" do
      ...
      expect {
        strategy.transfer
      }.to raise_error(StagingTable::ConfigurationError, /SQLite upsert requires :conflict_target/)
    end
  end
  ...
  describe StagingTable::AdapterError do
    it "is raised for unsupported adapter" do
      ...
      }.to raise_error(StagingTable::AdapterError, /Unsupported adapter: oracle/)
    end
